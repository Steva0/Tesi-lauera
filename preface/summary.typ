...
/ #link(<cap:modello-sicurezza>)[Il quarto capitolo]: espone l'analisi del codice sorgente #gl("cpl", capitalize: true) di #gl("rvc", capitalize: true), descrive le vulnerabilità individuate e presenta il modello di minaccia costruito secondo il framework Mitre-attack;
