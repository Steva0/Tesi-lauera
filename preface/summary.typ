...
/ #link(<cap:modello-sicurezza>)[Il quarto capitolo]: definisce il modello di sicurezza che un sistema di versionamento distribuito moderno dovrebbe soddisfare analizzando i requisiti formali, gerarchia di fiducia, livelli di sicurezza configurabili e meccanismo di #gl("redazione-trasparente", capitalize: true) — concludendo con l'analisi del divario rispetto alla versione iniziale di #gl("rvc", capitalize: true);
