...
/ #link(<cap:modello-sicurezza>)[Il quarto capitolo]: definisce il modello di sicurezza che un sistema di versionamento distribuito moderno dovrebbe soddisfare, analizzando le proprietà fondamentali richieste, la gerarchia di fiducia, i livelli di sicurezza configurabili e la gestione del ciclo di vita delle identità, concludendo con un'analisi del divario rispetto allo stato attuale di #gl("rvc", capitalize: true);
